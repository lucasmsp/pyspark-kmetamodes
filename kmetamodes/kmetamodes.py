...
class _IncrementalPartitionedKMetaModesParams(HasFeaturesCol, HasSeed,
    ...
    featuresCol = Param(Params._dummy(), "featuresCol", "Input column with a vector of attributes.")
    predictionCol = Param(Params._dummy(), "predictionCol", "Output column with the prediction.")

    def __init__(self, *args):
        super(_IncrementalPartitionedKMetaModesParams, self).__init__(*args)
...
class IncrementalPartitionedKMetaModes(Estimator,
                                       _IncrementalPartitionedKMetaModesParams):
    """
    ...
    def setParams(self, n_clusters=3, max_dist_iter=10, local_kmodes_iter=10,
                 similarity="hamming", metamodessimilarity="hamming", seed=None,
                 featuresCol=None, predictionCol=None):
        kwargs = self._input_kwargs
...
class IncrementalPartitionedKMetaModesModel(
        _IncrementalPartitionedKMetaModesParams, Model):
